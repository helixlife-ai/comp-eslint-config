...
import { GLOB_JSX_SRC, GLOB_TS_SRC } from '../constants'
import type { Options } from '../option'
import type { ConfigArray } from '../utils'

function formattingConfigs({ formatting, lessOpinionated, prettier }: Required<Options>): ConfigArray {
  ...
  return [
    ...
    },
    {
      ...
      rules: {
        '@stylistic/quotes': ['error', formatting.quotes, { allowTemplateLiterals: true, avoidEscape: true }],
